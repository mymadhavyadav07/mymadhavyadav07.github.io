...
export class AboutMadhav extends Component {
        ...
        return (
            <>
                <div id="about" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "about" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="About Madhav" src="./themes/Yaru/status/about.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">About Me</span>
                </div>
                <div id="education" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "education" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="Madhav's Education" src="./themes/Yaru/status/education.svg" />
                    <span className=" ml-1 md:ml-2 text-gray-50 ">Education</span>
                </div>
                <div id="skills" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "skills" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="Madhav's Skills" src="./themes/Yaru/status/skills.svg" />
                ...
                <div id="contact" tabIndex="0" onFocus={this.changeScreen} className={(this.state.active_screen === "contact" ? " bg-ub-orange bg-opacity-100 hover:bg-opacity-95" : " hover:bg-gray-50 hover:bg-opacity-5 ") + " w-28 md:w-full md:rounded-none rounded-sm cursor-default outline-none py-1.5 focus:outline-none duration-100 my-0.5 flex justify-start items-center pl-2 md:pl-2.5"}>
                    <img className=" w-3 md:w-4" alt="Contact Me" src="./themes/Yaru/status/projects.svg" />
...
export default AboutMadhav;

export const displayAboutMadhav = () => {
    return <AboutMadhav />;
}
    ...
    return (
        <>
            <div className="w-20 md:w-28 my-4 bg-white rounded-full">
                <img className="w-full" src="./images/logos/bitmoji.png" />
            </div>
            <div className=" mt-4 md:mt-8 text-lg md:text-2xl text-center px-1">
                <div>Hey, I am<span className="font-bold"> Madhav</span></div>
                <div className="font-normal ml-1">A<span className="text-pink-600 font-bold"> Cyber Security Researcher!</span></div>
            </div>
            ...
            <ul className=" mt-4 leading-tight tracking-tight text-sm md:text-base w-5/6 md:w-3/4 emoji-list">
                <li className=" list-pc">I'm a <span className=" font-medium">Under-Graduate Student</span> currently pursuing B.Tech in Computer Science. </li>
                <li className=" mt-3 list-building"> I enjoy building awesome softwares that solve practical problems.</li>
                <li className=" mt-3 list-time">Exploring Cyber Security.</li>
                <li className=" mt-3 list-star"> Meanwhile, solving CTFs!</li>
            </ul>
        </>
    )
}
        ...
        <>
            ...
            <ul className=" w-10/12  mt-4 ml-4 px-0 md:px-1">
                ...
                <li className="list-disc mt-5">
                    <div className=" text-lg md:text-xl text-left font-bold leading-tight">
                        Senior Secondary - Army Public School
                    </div>
                    <div className=" text-sm text-gray-400 mt-0.5">2011 - 2023</div>
    ...
    const project_list = [
        {
            ...
            domains: ["python", "OSINT", "monitoring", "API"]
        },
        {
            name: "The Hacker News Scraper",
            date: "July 2023",
            link: "https://github.com/mymadhavyadav07/The-Hacker-News-Scraper",
            description: [
                "Automate Hacker News updates. Scrape thehackernews.com and send real-time articles to your Discord channel.😀",
            ],
            domains: ["Python", "Web-Scraping", "Cyber Security", "Discord Bot"]
        },
        {
            name: "Library Management System",
            date: "Sep 2022",
            link: "https://github.com/mymadhavyadav07/Library-Management-System",
            description: [
                "A Client-Server Architecture Based Library Management System.",
            ],
            domains: ["Python", "MySQL", "Client-Server Architecture", "Graphical User Interface"]
        },
        {
            name: "The Vision",
            date: "July 2022",
            link: "https://github.com/mymadhavyadav07/The-Vision",
            description: [
                "Developed a Telegram bot for OSINT which can fetch OSINT inforamtion and send it to Telegram.",
            ],
            domains: ["Telegram Bot", "Python", "OSINT", "API"]
        },
        {
            name: "Github Followers Manipulation",
            date: "Sep 2022",
            link: "https://github.com/mymadhavyadav07/Github-Followers-Manipulation",
            description: [
                            ...
                            <div className="w-full py-1 px-2 my-2 border border-gray-50 border-opacity-10 rounded hover:bg-gray-50 hover:bg-opacity-5 cursor-pointer">
                                <div className="flex flex-wrap justify-between items-center">
                                    <div className='flex justify-center items-center'>
                                        ...
                                        <iframe src={`https://ghbtns.com/github-btn.html?user=mymadhavyadav07&repo=${projectName}&type=star&count=true`} frameBorder="0" scrolling="0" width="150" height="20" title={project.name.toLowerCase()+"-star"}></iframe>
                                    </div>
