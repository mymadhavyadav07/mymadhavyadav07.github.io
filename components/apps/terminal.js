...
export class Terminal extends Component {
    constructor() {
        ...
        this.child_directories = {
            ...
            skills: ["Python", "SQL", "Sqlite3", "Git", "Linux", "Django"],
            projects: ["Flight-Tracker", "The-Hacker-News-Scraper", "Library-Management-System", "The-Vision", "Github-Followers-Manipulation"],
            interests: ["Cyber Security", "Deep Learning", "Computer Vision", "Malware Analysis"],
        ...
        return (
            <React.Fragment key={id}>
                <div className="flex w-full h-5">
                    <div className="flex">
                        <div className=" text-ubt-green">madhav@lenovo</div>
    ...
    handleCommands = (command, rowId) => {
        ...
        switch (main) {
            ...
            case "pwd":
                ...
                result = str.replace("~", "/home/madhav")
                break;
            case "code":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("vscode");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands:[ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-madhav, todoist, trash, settings, sendmsg]";
                }
                break;
            case "echo":
            ...
            case "spotify":
                if (words[0] === "." || words.length === 0) {
                    ...
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-madhav, todoist, trash, settings]";
                }
                break;
            case "chrome":
                if (words[0] === "." || words.length === 0) {
            ...
            case "about-madhav":
                if (words[0] === "." || words.length === 0) {
                    this.props.openApp("about-madhav");
                } else {
                    result = "Command '" + main + "' not found, or not yet implemented.<br>Available Commands: [ cd, ls, pwd, echo, clear, exit, mkdir, code, spotify, chrome, about-madhav, todoist, trash, settings, sendmsg ]";
                }
                break;
