    ...
    <div className="mt-5">
      ...
      <VerticalTimeline>
        ...
        <VerticalTimelineElement
          ...
          icon={<DiDjango />}
        >
          <h3 className="vertical-timeline-element-title">DJANGO FRAMEWORK</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
          ...
          icon={<DiLinux />}
        >
          <h3 className="vertical-timeline-element-title">LINUX OS</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
          ...
          icon={<DiGit />}
        >
          <h3 className="vertical-timeline-element-title">GIT REPOSITORY MANAGEMENT</h3>
        </VerticalTimelineElement>
        <VerticalTimelineElement
          className="vertical-timeline-element--work"
          contentStyle={{ background: "rgb(78 22 112)", color: "#fbd9ad" }}
